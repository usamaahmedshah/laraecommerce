                      ...
                      <div class="tab-content" id="myTabContent">
                        <div class="tab-pane  fade border p-3 show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="brand" class="form-control">
                                    ...
                                    <option value="{{ $brand->id }}" {{ $category->name == $product->brand ? 'selected':'' }}>
                                        {{ $brand->name }}
                                    </option>    
                                    @endforeach
                                    <option value=""></option>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="small_description" class="form-control">value="{{ $product->small_description }}"</textarea>
                            </div>
                            <div class="mb-3">
                        ...
                        <div class="tab-pane  fade border p-3" id="seotags-tab-pane" role="tabpanel" aria-labelledby="seotags-tab" tabindex="0">
                            <div class="mb-3">
                                ...
                                <input type="text" name="meta_title" value="{{ $product->meta_title }}" class="form-control" rows="4">
                            </div>
                            <div class="mb-3">
                                <label>Meta Description</label>
                                <textarea name="meta_description" class="form-control rows=4">value="{{ $product->description }}"</textarea>
                            </div>
                            <div class="mb-3">
                                <label>Meta keyword</label>
                                <textarea name="meta_keyword" class="form-control" rows="4">value="{{ $product->meta_keyword }}"</textarea>
                            </div>
                        </div>
